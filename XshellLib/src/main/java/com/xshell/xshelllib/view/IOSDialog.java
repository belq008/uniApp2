...
public class IOSDialog {
    ...
    public IOSDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.xinyusoft_view_ios_alertdialog, null);
    ...
    private void setLayout() {
        ...
        if (!showPosBtn && !showNegBtn) {
            ...
            btn_pos.setBackgroundResource(R.drawable.xinyusoft_iosdialog_single_selector);
            btn_pos.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    dialog.dismiss();
        ...
        if (!showPosBtn && showNegBtn) {
            btn_neg.setVisibility(View.VISIBLE);
            btn_neg.setBackgroundResource(R.drawable.xinyusoft_iosdialog_single_selector);
        }
    }

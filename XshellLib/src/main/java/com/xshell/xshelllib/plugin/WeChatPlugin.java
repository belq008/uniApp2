...
import com.xshell.xshelllib.tools.weixin.HttpUtil;
...
public class WeChatPlugin extends CordovaPlugin {
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        // 将该app注册到微信
        api.registerApp("wx25eb1dc94a1234cf");
        mcordova = cordova;
...
//        String callBackName = "callbackContext";
...
//            Log.e("huanghu","进入微信=========");
                ...
                LogUtils.i("zzy", "WX_APP_ID:" + WX_APP_ID + "----WX_SECRET:" + WX_SECRET);
            ...
            Toast.makeText(cordova.getActivity(), "jo" + jo.toString(), Toast.LENGTH_SHORT).show();
            try {
                LogUtils.e("huanghu", "分享功能");
                Map<String, String> configInfo = ParseConfig.getInstance(cordova.getActivity()).getConfigInfo();
            ...
            Toast.makeText(cordova.getActivity(), "wxpay" + args.getString(0), Toast.LENGTH_SHORT).show();
            //调起微信支付页面
            sendPayReq(args, callbackContext);
            LogUtils.e("huang", "wxpay");
        }
        return false;
    }
            ...
            weixinInstance.loadWXUserInfo(WX_SECRET, weixinInstance.getWXCode(), new WeixinUtil.GetUserInfoListener() {
                ...
                public void onResp(final String userInfo) {
                    try {
                        ...
                        Log.e("amtf", "拿到用户信息" + object.toString());

                        mCallbackContext.success(object);

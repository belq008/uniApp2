...
public class DataLocalityPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if ("getArr".equals(action)) {//从数据库取出数组
            ...
            Log.e("huang", type + "==" + pageNum + "==" + dataNum + "==" + descAndAsc);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Log.e("huang", "取出数据：" + arrayData.toString());
            ...
            Log.e("huang", "表明：" + type + "===数组为：" + arr.toString());
            dataLocalityManager.openSQLData();
            ...
            Log.e("huang", "=========key:" + key + "=====value:" + value);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        final String type = args.getString(0);
                        final JSONArray arr = args.getJSONArray(1);
                        Log.e("huang", "新需求表明：" + type + "===新需求数组为：" + arr.toString() + "数组的长长度： " + arr.length());
                        Log.e("huang", "数组的长长度： " + arr.length());
                        dataLocalityManager.openSQLData();
...
//            getArrDataByIDThread.start();
            cordova.getThreadPool().execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        //String[] split = arr.split(",");
                        Log.e("huang", "获取新需求表明：" + type + "获取===新需求数组为：" + arr.toString());
                        dataLocalityManager.openSQLData();
                        dataLocalityManager.createArrayKeyTableSql(type);
                        //JSONArray idData = dataLocalityManager.getIdData(type, split);
                        ...
                        if (idData != null) {
                            ...
                            Log.e("huang", "getArrDataByID查询结果为：" + idData.toString());
                        } else {
                            callbackContext.error("error");
                        }
                    } catch (Exception e) {
            ...
            Log.e("huang", "数据库的路径=======" + pathDatabase);
            //获取图片文件大小
            ...
            Log.e("huang", "图片大小：" + imageFileSize + "====数据库大小" + databaseSize + "==总：" + zong);
            ...
            Log.e("huang", "根据key查询数据:" + args.getString(0) + "==:" + args.getString(1));
            final String key = args.getString(0);
...
//                            }
//                        }
                        Log.e("huang", "getArrAllData获取的数组长度：：" + keyAllData.length());
                        Log.e("huang", "getArrAllData获取的数组：" + keyAllData);
                        if (keyAllData != null) {
...
//        }
    ...
    private String setImagesMessageData(CallbackContext callbackContext, String imageUrl, String type) {
        ...
        if (file.exists() && file.length() > 0) {  //存在就直接返回
            ...
            Log.e("huang", "获取图片的属性：" + date);
            return file.getPath();
        } else {
            fileName = fileName + ".jpg";
            Log.e("huanghu", "mFileName" + mFileNameArr + "===" + "fileName" + fileName);

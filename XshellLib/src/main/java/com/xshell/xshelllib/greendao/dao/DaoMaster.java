...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AppUpdateDao.createTable(db, ifNotExists);
        FileCacheDao.createTable(db, ifNotExists);
        XLogDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        HintDao.dropTable(db, ifExists);
        AppUpdateDao.dropTable(db, ifExists);
        FileCacheDao.dropTable(db, ifExists);
        XLogDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AppUpdateDao.class);
        registerDaoClass(FileCacheDao.class);
        registerDaoClass(XLogDao.class);
    }

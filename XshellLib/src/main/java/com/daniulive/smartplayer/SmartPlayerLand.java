...
//
//public class SmartPlayerLand extends Activity implements OnPushWtTextMessage, View.OnClickListener {
//
...
//    private RelativeLayout rlPlayTop, presentRelative, buttomcontrl, buttonSay, rlPlay, buttonInfo,
//            bossRela, backgroundMaterialRelative, redpacketShowRelative, choosepayRelative, personalRelative,
//            rangseekbarRelative, redpacketDetailRelative, redpacketHasRelative, redpacketGoneRelative;
//    private LinearLayout llBottomLayout, llFullscreen;
...
//        setContentView(R.layout.room_smartplay_ladscape);
//        Log.i(TAG, "Run into OnCreate++");
//        roomid = getIntent().getStringExtra("id");
//        libPlayer = new SmartPlayerJni();
//        myContext = this.getApplicationContext();
//        serverIntent = new Intent(SmartPlayerLand.this, HeartService.class);
...
//        buttonInfo = (RelativeLayout) findViewById(R.id.button_info_botton);
...
//        ivOthernone.setOnClickListener(SmartPlayerLand.this);
...
//        bossRela = (RelativeLayout) findViewById(R.id.boss_rela);
...
//        bossRela.setOnClickListener(this);
//        ivOther.setOnClickListener(this);
...
//        });
//
//        madapter = new RedpacketDetailAdapter(SmartPlayerLand.this, options, detaillist);
//        detailListview.setAdapter(madapter);
//        redpacketListadapter = new redpacketListAdapter(SmartPlayerLand.this, redpacketlist, redpacketlistview);
...
//        });
//
//        sayadapter = new SayAdapter(SmartPlayerLand.this, mlist);
//        listview = (ListView) findViewById(R.id.list_say);
...
//        CustomDialog.Builder builder = new CustomDialog.Builder(SmartPlayerLand.this);
...
//            Intent in = new Intent(SmartPlayerLand.this, BackgroundMaterial.class);
//            SmartPlayerLand.this.startActivity(in);
